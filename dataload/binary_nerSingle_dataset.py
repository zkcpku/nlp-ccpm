        ...
        def split_string(c,l = 5,remove_dot = True):
            if remove_dot:
                if l == 5:
                    ...
                    return [c[0:1],c[1:2],c[2:3],c[3:4],c[4:5],c[5:6],c[6:7]]
                elif l == 12:
                    return [c[0:1],c[1:2],c[2:3],c[3:4],c[4:5],c[6:7],c[7:8],c[8:9],c[9:10],c[10:11]]
                elif l == 16:
                    return [c[0:1],c[1:2],c[2:3],c[3:4],c[4:5],c[5:6],c[6:7],c[8:9],c[9:10],c[10:11],c[11:12],c[12:13],c[13:14],c[14:15]]
            else:
                if l == 5:
                    return [c[0:1],c[1:2],c[2:3],c[3:4],c[4:5]]
                elif l == 7:
                    ...
                    return [c[0:1],c[1:2],c[2:3],c[3:4],c[4:5],c[5:6],c[6:7],c[7:8],c[8:9],c[9:10],c[10:11],c[11:12]]
                elif l == 16:
                    return [c[0:1],c[1:2],c[2:3],c[3:4],c[4:5],c[5:6],c[6:7],c[7:8],c[8:9],c[9:10],c[10:11],c[11:12],c[12:13],c[13:14],c[14:15],c[15:16]]
...
def unit_test():
    ...
    data_collator = DataBinaryNerSingleCls(tokenizer=tokenizer, pad_to_multiple_of=8)
