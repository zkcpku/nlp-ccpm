...
from dataload.binary_ner_dataset import get_preprocess_function
from dataload.binary_ner_dataset import DataBinaryNerCls
...
def main():
    ...
    # Data collator
    data_collator = DataBinaryNerCls(tokenizer=tokenizer, pad_to_multiple_of=8 if training_args.fp16 else None)
